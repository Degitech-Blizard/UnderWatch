...
CFrameTimer g_SystemFrameTimer;
#ifndef ARRAYSIZE
...
HRESULT WINAPI DXUTMainLoop(HACCEL hAccel)
{
	...
	CFrameSkip g_SystemFrameLimiter;
	g_SystemFrameLimiter.SetFramePerSec(FPSLimit);

		while (WM_QUIT != msg.message)
		{
			g_SystemFrameTimer.Update();
			...
			{
				if (g_SystemFrameLimiter.Update(g_SystemFrameTimer.GetDeltaTime()))
				{
			...
			TIME.m_fDeltaTime = g_FrameTimer.GetDeltaTime();
			TIME.m_fFPS = g_FrameTimer.GetFPS();
		}
