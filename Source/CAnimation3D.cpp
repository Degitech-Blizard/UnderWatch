...
void CAnimation3D::Awake()
{
}

void CAnimation3D::Start()
{
}
...
void CAnimation3D::Update()
{
	if (m_pHandleAnimator)
	{
		if(m_pHandleAnimator->GetEnable())
...
void CAnimation3D::LateUpdate()
{
}

void CAnimation3D::OnDestroy()
{
...
void CAnimation3D::OnRender()
{
}

void CAnimation3D::OnEnable()
{
}

void CAnimation3D::OnDisable()
{
}
