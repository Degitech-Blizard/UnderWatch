...
Vector3 Math::Vec3GetDirection(Vector3 _vFrom, Vector3 _vTo)
{
	Vector3 vDir = _vTo - _vFrom;
	D3DXVec3Normalize(&vDir, &vDir);
	return vDir;
}

Vector2 Math::Vec2GetDirection(Vector2 _vFrom, Vector2 _vTo) 
{
	Vector2 vDir = _vTo - _vFrom;
